...
const projects = [
  {
    ...
    description:
      'A full-featured e-commerce mobile application with AI-powered product recommendations and seamless payment integration.',
    image: '/api/placeholder/400/300',
    category: 'mobile',
    technologies: ['React Native', 'Node.js', 'MongoDB', 'Stripe', 'OpenAI'],
    liveUrl: '#',
    githubUrl: '#',
    featured: true,
  },
  {
    ...
    description:
      'Real-time analytics dashboard with machine learning insights and predictive analytics for business intelligence.',
    image: '/api/placeholder/400/300',
    category: 'web',
  ...
  },
  {
    ...
    description:
      'IoT-based smart home automation system with voice control and AI-powered energy optimization.',
    image: '/api/placeholder/400/300',
    category: 'ai',
  ...
  },
  {
    ...
    description:
      'Comprehensive healthcare management platform with patient records, appointment scheduling, and telemedicine features.',
    image: '/api/placeholder/400/300',
    category: 'web',
    technologies: ['React', 'Node.js', 'PostgreSQL', 'WebRTC', 'HIPAA'],
    liveUrl: '#',
    githubUrl: '#',
    featured: false,
  },
  ...
  },
  {
    ...
    description:
      'Enterprise-grade platform for integrating ChatGPT and other AI models into business workflows.',
    image: '/api/placeholder/400/300',
    category: 'ai',
    technologies: ['Next.js', 'OpenAI API', 'Redis', 'Docker', 'Kubernetes'],
    liveUrl: '#',
    githubUrl: '#',
    featured: true,
  },
